...
command sudo apt-get install -qq -y git xclip trash-cli bash bash-completion vim-gtk3 tmux \
      wamerican python3 fd-find fzy htop fonts-cascadia-code || error-echo "installing from apt"
# ---
